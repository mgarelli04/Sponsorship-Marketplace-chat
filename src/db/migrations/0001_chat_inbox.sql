...
CREATE UNIQUE INDEX "chat_connections_open_pair_unique" ON "chat_connections" USING btree ("creator_id", "sponsor_company_id") WHERE "status" <> 'closed';--> statement-breakpoint
